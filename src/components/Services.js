...
const SERVICES = [
  {
    ...
    icon: IconWeb,
    bullets: [
      'Custom websites and business websites',
  ...
  },
  {
    ...
    icon: IconMegaphone,
    bullets: [
      'Facebook, Instagram, TikTok, LinkedIn marketing',
...
export default function Services() {
  ...
  return (
    <section className="relative bg-white py-14 sm:py-14 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 relative z-10">
        <div className="mb-20">
          ...
          <p className="text-base text-gray-600 max-w-4xl leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            We provide comprehensive digital services including web development, graphic design, social media marketing, and e-commerce support for platforms like eBay, Amazon, and Shopify.
          </p>
        </div>
          ...
          {SERVICES.map((service, index) => {
            ...
            return (
              <div key={index} className="group [perspective:1000px]">
                <div 
                  className={`relative h-52 w-full rounded-2xl border border-gray-200 bg-white shadow-lg hover:shadow-2xl transition-all duration-500 [transform-style:preserve-3d] cursor-pointer md:cursor-default ${
                ...
                >
                  ...
                  <div className="absolute inset-0 p-8 backface-hidden [transform:rotateY(0deg)] flex flex-col">
                    <div className="h-16 w-16 grid place-items-center rounded-2xl bg-black/5 group-hover:bg-black/10 transition-colors duration-300">
                      <Icon />
                    </div>
                    <h3 className="mt-6 text-xl font-bold text-gray-900 group-hover:text-black transition-colors duration-300" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                      {service.title}
                    </h3>
                    ...
                    <div className="mt-auto text-xs text-black font-medium md:hidden" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                      Tap to see details
                    </div>
                  </div>
                  {/* Back */}
                  <div className="absolute inset-0 p-8 backface-hidden [transform:rotateY(180deg)] flex flex-col bg-black/5 rounded-2xl">
                    <h4 className="text-base font-bold text-black mb-4" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                      What you get
                    </h4>
