      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center mb-4">
            ...
            <span className="px-4 text-black font-semibold text-sm uppercase tracking-widest" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              Portfolio
            </span>
            <div className="h-px w-8 bg-black"></div>
          </div>
          ...
          <p className="text-base text-gray-600 leading-relaxed max-w-3xl mx-auto" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            Explore our comprehensive collection of digital solutions, web development projects, e-commerce stores, and creative designs
          </p>
        </div>
          ...
          {projects.map((project, index) => {
            ...
            return (
              <Reveal key={project.id} direction={isEven ? 'left' : 'right'} delayMs={80 * index}>
                <div className={`group relative bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-2xl hover:border-black/20 transition-all duration-500 ${!isEven ? 'md:flex-row-reverse' : ''}`}>
                  <div className={`flex flex-col md:flex-row ${!isEven ? 'md:flex-row-reverse' : ''}`}>
                    ...
                    <div className="w-full md:w-7/12 lg:w-1/2 p-4 lg:p-6 flex flex-col justify-center">
                      <div className="inline-flex items-center gap-2 mb-4">
                        ...
                        <span className="text-xs font-semibold text-black uppercase tracking-wider" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                          Project {String(index + 1).padStart(2, '0')}
                        </span>
                      </div>

                      <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 group-hover:text-black transition-colors duration-300" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                        {project.title}
                      </h3>
                      ...
                      {project.details && (
                        <button
                          ...
                          className="inline-flex items-center gap-2 text-black font-semibold group/btn"
                      ...
                      {project.details && openId === project.id && (
                        ...
                        >
                          <button
                            ...
                            className="inline-flex items-center gap-2 text-black font-semibold hover:gap-3 transition-all duration-300 group/btn absolute bottom-6 right-6 z-30 px-4 py-2 bg-white border border-black rounded-lg shadow hover:bg-gray-50"
                            style={{ fontFamily: 'Montserrat, sans-serif' }}
                          >
                          ...
                          {/* Tabs */}
                          <div className="flex border-b border-gray-200 bg-white overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100" style={{ minHeight: '56px' }}>
                          ...
                          {/* Tab Content */}
                          <div className="p-6 lg:p-8 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100" style={{ flex: 1, minHeight: 0 }}>
