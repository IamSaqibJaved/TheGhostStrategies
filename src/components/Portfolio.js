      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-base text-gray-600 leading-relaxed max-w-3xl mx-auto" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            Explore our diverse portfolio showcasing successful digital solutions, web development projects, e-commerce stores, and creative designs for clients across various industries.
          </p>
        </div>
        ...
        <div className="text-center">
          <Link
            href="/portfolio"
            className="inline-flex items-center px-8 py-4 bg-black text-white font-semibold rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300 transform hover:bg-gray-800"
            style={{ fontFamily: 'Montserrat, sans-serif' }}
          >
            View Our All Work
