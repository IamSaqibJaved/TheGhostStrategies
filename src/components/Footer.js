  ...
  return (
    <footer className="bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-white/3 rounded-full blur-3xl" />
        <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-white/3 rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-white/2 rounded-full blur-2xl" />
      </div>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              <div className="space-y-4 mb-8">
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    A digital service agency with 8+ years of experience providing professional digital solutions such as Web Development, Graphic Designing, Social Media Marketing, and e-commerce support for platforms like eBay, Amazon, and Shopify.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    Email: Support@theghoststrategies.store<br />
                    Phone: +44 7413 467197<br />
                    Address: 75a Manchester Road, Denton, Manchester M34 2AF
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Quick Links */}
                <div>
                  <h3 className="text-xl font-bold mb-6 text-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    Company
                  </h3>
              ...
              <div className="mt-8">
                ...
                <div className="bg-gray-900 rounded-xl overflow-hidden shadow-2xl">
                  ...
                  <div className="relative w-full h-64">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2374.5!2d-2.1183!3d53.4568!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487bb4e8b8b8b8b%3A0x8b8b8b8b8b8b8b8b!2s75a%20Manchester%20Road%2C%20Denton%2C%20Manchester%20M34%202AF!5e0!3m2!1sen!2suk!4v1234567890!5m2!1sen!2suk"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen=""
                      ...
                      title="The Ghost Strategies Office Location"
                    ></iframe>
                  </div>
                </div>
                <p className="text-gray-400 text-sm mt-3" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                  Visit our Manchester office or connect with us remotely worldwide
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            <div className="text-gray-400 text-sm" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              © 2025 The Ghost Strategies. All rights reserved.
            </div>
          </div>
        </div>
      </div>
