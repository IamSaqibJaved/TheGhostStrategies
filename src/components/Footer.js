            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    Email: theghoststrategiesllc@gmail.com<br />
                    Phone: +44 7413 467197<br />
                    Address: 43 S OGDEN ST DENVER, CO 80209
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="bg-gray-900 rounded-xl overflow-hidden shadow-2xl">
                  ...
                  <div className="relative w-full h-64">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3067.5!2d-104.9803!3d39.7392!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x876c7f2c8b8b8b8b%3A0x8b8b8b8b8b8b8b8b!2s43%20S%20Ogden%20St%2C%20Denver%2C%20CO%2080209!5e0!3m2!1sen!2sus!4v1234567890!5m2!1sen!2sus"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen=""
                ...
                <p className="text-gray-400 text-sm mt-3" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                  Visit our Denver office or connect with us remotely worldwide
                </p>
              </div>
            </div>
          </div>
